...
def reconstruct(A, n, s, L):
    ...
    # # xinv = spgl1_pylops(A=Aop, b=y, sigma=0.1, iter_lim=2000, project=spgl1.norm_l1nn_project)[0]
...
# n_measurements = range(320, m, 200)  # number of measurements across which to test
n = 20 #20
s = 40 #40
...
np.savez('measurements_results_2D_cvx.npz', lengths=lengths, n_measurements=n_measurements, p_success_dict=p_success_dict)